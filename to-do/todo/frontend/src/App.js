          ...
          <div id="form-wrapper">
            <form onSubmit={this.handleSubmit} id="form">
              <div className="flex-wrapper">
                <div style={{flex: 6}}>
                  <input onChange={this.handleChange} className="form-control" id="title" value={this.state.activeItem.title} type="text" name="title" placeholder="Enter Task" autoComplete="off" />
            ...
            {tasks.map(function(task, index){
              return(
                <div key={index} className="task-wrapper flex-wrapper">
                  ...
                  <div style={{flex:1}}>
                    <button onClick={() => self.deleteItem(task)} type="button" className="btn btn-danger ">--</button>
                  </div>
